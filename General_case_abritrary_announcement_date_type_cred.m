...
%Computation of matrix recursion
 for t=T_sim:-1:1     
    ...
    B1t_IC = ind_IC(t,1)*B1 + (1-ind_IC(t,1))*B1_tild;
    B2t_IC = ind_IC(t,1)*B2 + (1-ind_IC(t,1))*B2_tild;
    B3t_IC = ind_IC(t,1)*B3 + (1-ind_IC(t,1))*B3_tild;
    B4t_IC = ind_IC(t,1)*B4 + (1-ind_IC(t,1))*B4_tild;
    B5t_IC = ind_IC(t,1)*B5 + (1-ind_IC(t,1))*B5_tild;
