% Algorithm for computing the unique fixed-structure fundamental rational expectations solution 
%using time iteration (along the lines of Cho and Moreno (2011, JEDC))
